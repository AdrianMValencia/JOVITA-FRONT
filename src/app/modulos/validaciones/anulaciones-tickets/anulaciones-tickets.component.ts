...
import { RecibosService } from '../../ventas/recibos/service/recibos.service';
...
import { Recibos } from '../../ventas/recibos/model/recibos';
...
import { RecibosDetalles } from '../../ventas/recibos/model/recibosDetalles';
import { NgbModal, NgbModalOptions } from '@ng-bootstrap/ng-bootstrap';
import { ModalRecibosPDFComponent } from '../../ventas/recibos/modalRecibosPDF/modalRecibosPDF.component';
import { ModalRecibosCorreoComponent } from '../../ventas/recibos/modalRecibosCorreo/modalRecibosCorreo.component';
...
@Component({
  selector: 'app-anulaciones-tickets',
  templateUrl: './anulaciones-tickets.component.html',
  providers: [ RecibosService, ClientesService, ProductosService, SeriesticketsService],
  styleUrls: ['./anulaciones-tickets.component.scss'],
  animations: [ VentasAnimations ]
})
export class AnulacionesTicketsComponent implements OnInit {
