...
@Component({
  selector: 'app-reporteventastotales',
  templateUrl: './reporteventastotales.component.html',
  providers: [ReportesService]
})
export class ReporteventastotalesComponent implements OnInit {
  // FormGroup
  ...
  loadMain() {
    ...
    this.service.cargarReporteVentasTotales(this.formGroup.get('fechaIni').value, this.formGroup.get('fechaFin').value, this.puntoVentas.id).subscribe(response => {
