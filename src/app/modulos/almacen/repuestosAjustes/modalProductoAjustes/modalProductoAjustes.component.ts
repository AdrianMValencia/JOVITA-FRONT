...
@Component({
  selector: 'app-modalProductoAjustes',
  templateUrl: './modalProductoAjustes.component.html',
  providers: [ProductoAjustesService, ProductosService]
})
export class ModalProductoAjustesComponent implements OnInit {
