...
import { ModalOrdenRequerimientoPdfComponent } from './modal-orden-requerimiento-pdf/modal-orden-requerimiento-pdf.component';
import { ModalOrdenRequerimientoComponent } from './modal-orden-requerimiento/modal-orden-requerimiento.component';
...
const MODALS: { [name: string]: Type<any> } = {
  ordenRequerimiento: ModalOrdenRequerimientoComponent,
  downloadPDF: ModalOrdenRequerimientoPdfComponent
};

@Component({
  selector: 'app-orden-requerimiento',
  templateUrl: './orden-requerimiento.component.html',
  providers: [ OrdenRequerimientoService ]
})
export class OrdenRequerimientoComponent implements OnInit {
 ...
 // FormGroup
  ...
  // PRINCIPAL
  MainDC: string[] = ['pedido', 'fechaPedido', 'puntoVenta', 'vendedor', 'estadoActual', 'acciones'];
  ...
  ngOnInit() {
    ...
    this.fgMain.get('estadoActual').setValue([1]);
  ...
  downloadPDF(){
    ...
    doc.autoTable({
      ...
      margin: {top: 40},
      head: [[ "NRO DE PEDIDO", "FECHA DE PEDIDO", "PUNTO DE VENTA", "VENDEDOR", "ESTADO"]],
  ...
  downloadExcel(){
    ...
    const header = [ "NRO DE PEDIDO", "FECHA DE PEDIDO", "PUNTO DE VENTA", "VENDEDOR", "ESTADO"];
